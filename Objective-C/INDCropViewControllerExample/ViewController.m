...
@interface ViewController () <UINavigationControllerDelegate, UIImagePickerControllerDelegate, INDCropViewControllerDelegate>
...
@property (nonatomic, assign) INDCropViewCroppingStyle croppingStyle; //The cropping style
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary<NSString *,id> *)info
{
    ...
    INDCropViewController *cropController = [[INDCropViewController alloc] initWithCroppingStyle:self.croppingStyle image:image];
    ...
    //cropController.aspectRatioPreset = INDCropViewControllerAspectRatioPresetSquare; //Set the initial aspect ratio as a square
    ...
    //cropController.toolbarPosition = INDCropViewControllerToolbarPositionTop;
    
    // -- Uncomment this line of code to include only certain type of preset ratios
    //cropController.allowedAspectRatios = @[@(INDCropViewControllerAspectRatioPresetOriginal),
...
- (void)didTapImageView
{
    ...
    INDCropViewController *cropController = [[INDCropViewController alloc] initWithCroppingStyle:self.croppingStyle image:self.image];
    cropController.delegate = self;
...
- (void)updateImageViewWithImage:(UIImage *)image fromCropViewController:(INDCropViewController *)cropViewController
{
    ...
    if (cropViewController.croppingStyle != INDCropViewCroppingStyleCircular) {
...
- (void)showCropViewController
{
    ...
    UIAlertAction *defaultAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Crop Image", @"")
                                           ...
                                           handler:^(UIAlertAction *action) {
                                               self.croppingStyle = INDCropViewCroppingStyleDefault;
    ...
    UIAlertAction *profileAction = [UIAlertAction actionWithTitle:NSLocalizedString(@"Make Profile Picture", @"")
                                           style:UIAlertActionStyleDefault
                                         handler:^(UIAlertAction *action) {
                                             self.croppingStyle = INDCropViewCroppingStyleCircular;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = NSLocalizedString(@"INDCropViewController", @"");
